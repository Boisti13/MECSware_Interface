...
freq_label.grid(row=2, column=4, pady=(5), padx=(0, 100), sticky=tk.W)

bw_label = ttk.Label(frame, text="[MHz]", width=width_c-8, anchor=tk.W, font=Entries_bold_font)
bw_label.grid(row=3, column=4, pady=(10,0), padx=(0, 100), sticky=tk.W)
...
power_label.grid(row=5, column=4, pady=(10,0), padx=(0, 100), sticky=tk.W)
