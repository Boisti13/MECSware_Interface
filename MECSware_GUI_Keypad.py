...
port_entry = ttk.Entry(frame, width=width_c-10, justify='center', font = standard_font)
port_entry.insert(0, port_initial)
port_entry.grid(row=0, column=3, columnspan=1, padx=(10, 20))
...
bw_label.grid(row=3, column=4, pady=(10,0), padx=(0, 50), sticky=tk.W)
...
power_label.grid(row=5, column=4, pady=(10,0), padx=(0, 50), sticky=tk.W)
...
submit_button.grid(row=6, column=2, pady=(15, 5), padx=(100, 0), columnspan=2)
